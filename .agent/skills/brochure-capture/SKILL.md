...
description: Automatically visits Feel Japan itinerary URLs, captures them as A4 PDFs, applies a logo watermark, and uploads them to Supabase Storage. Use this when the website itineraries change or when new brochures are needed for prospects.
---
...
3.  **Capture:** Navigate to each URL (Live Site: `https://feel-japan.vercel.app`), wait for images/fonts to load, and save as an A4 PDF locally to `dist/brochures/`.
