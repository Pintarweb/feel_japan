        ...
        <main className="relative min-h-screen bg-off-white">
            ...
            <section className="py-24 px-6 md:px-12 max-w-7xl mx-auto">
                <div className="text-center mb-16">
                    <p className="text-midnight-navy/60 uppercase text-xs font-bold tracking-widest">Stay Informed</p>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white overflow-hidden rounded-[2rem] shadow-sm hover:shadow-xl transition-all border border-midnight-navy/5">
                        ...
                        <div className="p-8">
                            ...
                            <p className="text-sm text-midnight-navy/60 leading-relaxed line-clamp-3">
